...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("В этой функции используется обычное Лямбда-выражение." +
        ...
        System.out.println("В этой функции используется Лямбда-выражение," +
                " принимающее один аргумент. Результат выполнения функции: ");
        ...
        System.out.println("В этой функции используется Лямбда-выражение," +
                " принимающее два аргумента. Результат выполнения функции: ");
        ...
        System.out.println("В этой функции используется блочное Лямбда-выражение." +
                " Результат выполнения функции: ");
